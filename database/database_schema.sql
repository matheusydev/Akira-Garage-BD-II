...
-- Restrições explícitas do atendente
...
-- Leitura de tabelas de referência
GRANT SELECT ON TABLE VEICULO, MODELO, FABRICANTE TO role_mecanico;

-- Apenas colunas não sensíveis da tabela PECA
